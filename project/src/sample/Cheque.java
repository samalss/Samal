...
public class Cheque extends BuyProducts implements Initializable {
...
public void initialize(URL url,ResourceBundle rb){
        name_label.setText(DBManager.staticName);
        SimpleDateFormat formatter=new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
        Date date=new Date();
        String dataCheque=formatter.format(date);
        date_label.setText(dataCheque);
